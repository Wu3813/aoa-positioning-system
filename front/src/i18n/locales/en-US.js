export default {
  ...
  admin: {
    ...
    trajectoryRetention: 'Trajectory Data Retention',
    retentionDays: 'Retention Days:',
    days: 'days',
    retentionWarning: 'The system will automatically delete historical trajectory data older than the retention period. Recommended range: 1-365 days',
    diskSpaceManagement: 'Disk Space Management',
    diskSpaceThreshold: 'Disk Space Threshold:',
    diskCleanupWarning: 'When disk free space falls below the threshold, the system will automatically clean up the oldest trajectory data to free up space',
    retentionDaysWarning: 'Retention days must be between 1 and 365',
    diskThresholdWarning: 'Disk space threshold must be between 5% and 50%',
    enabled: 'Enabled',
    disabled: 'Disabled',
