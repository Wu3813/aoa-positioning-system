export default {
  ...
  admin: {
    ...
    dataRetentionPolicy: '數據保留策略',
    trajectoryRetention: '軌跡數據保留',
    retentionDays: '保留天數:',
    days: '天',
    retentionWarning: '系統將自動刪除超過保留天數的歷史軌跡數據，建議根據實際需求設置（1-365天）',
    diskSpaceManagement: '磁盤空間管理',
    diskSpaceThreshold: '磁盤空間閾值:',
    diskCleanupWarning: '當磁盤剩餘空間低於閾值時，系統將自動清理最舊的軌跡數據以釋放空間',
    retentionDaysWarning: '數據保留天數必須在1-365天之間',
    diskThresholdWarning: '磁盤空間閾值必須在5%-50%之間',
    enabled: '啟用',
    disabled: '禁用',
    saveConfig: '保存配置',
    resetConfig: '重置配置',
