export default {
  ...
  admin: {
    ...
    trajectoryRetention: '轨迹数据保留',
    retentionDays: '保留天数:',
    days: '天',
    retentionWarning: '系统将自动删除超过保留天数的历史轨迹数据，建议根据实际需求设置（1-365天）',
    diskSpaceManagement: '磁盘空间管理',
    diskSpaceThreshold: '磁盘空间阈值:',
    diskCleanupWarning: '当磁盘剩余空间低于阈值时，系统将自动清理最旧的轨迹数据以释放空间',
    retentionDaysWarning: '数据保留天数必须在1-365天之间',
    diskThresholdWarning: '磁盘空间阈值必须在5%-50%之间',
    enabled: '启用',
    disabled: '禁用',
    saveConfig: '保存配置',
    resetConfig: '重置配置',
