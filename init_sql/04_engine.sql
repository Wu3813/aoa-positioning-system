...
('主实验室引擎', '192.168.1.100', 1, '实验室一楼', 1, '2023-10-15 14:30:22', '2023-08-10 09:15:00', '主实验室使用的定位引擎'),
('生产区引擎', '192.168.1.101', 2, '生产区域', 0, '2023-10-14 16:45:10', '2023-08-12 11:20:00', '生产区域使用的定位引擎'),
('测试引擎', '192.168.1.102', 3, '测试区域', 1, '2023-10-15 10:12:35', '2023-09-05 14:30:00', '用于新功能测试的引擎');
