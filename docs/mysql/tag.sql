...
CREATE TABLE `tag` (
  ...
  `code` varchar(50) NOT NULL COMMENT '标签编号',
  `name` varchar(100) NOT NULL COMMENT '标签名称',
  `group_name` varchar(100) DEFAULT NULL COMMENT '标签分组',
...
-- 样例数据
INSERT INTO `tag` (`code`, `name`, `group_name`, `mac_address`, `model`, `firmware_version`, `map_id`, `map_name`, `rssi`, `position_x`, `position_y`, `position_z`, `battery_level`, `status`, `last_seen`, `create_time`, `remark`) VALUES
('TAG001', '员工标签-张三', '员工组', 'AA:BB:CC:DD:EE:01', 'WT-01', 'v2.1.0', 1, '实验室一楼', -65, 10.5, 20.3, 1.5, 85, 1, '2023-10-15 14:30:22', '2023-08-10 09:15:00', '张三使用的员工标签'),
('TAG002', '设备标签-AGV01', '设备组', 'AA:BB:CC:DD:EE:02', 'WT-02', 'v2.0.3', 1, '实验室一楼', -72, 15.8, 30.2, 0.5, 60, 1, '2023-10-15 14:35:10', '2023-08-12 11:20:00', 'AGV小车使用的标签'),
('TAG003', '访客标签-001', '访客组', 'AA:BB:CC:DD:EE:03', 'WT-01', 'v2.1.0', 2, '生产区域', -80, 25.4, 40.8, 1.2, 30, 0, '2023-10-14 16:45:10', '2023-09-05 14:30:00', '用于访客临时使用'); 